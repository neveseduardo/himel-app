...
- Cada model do projeto deve ter suporte a filtros e paginação.
- Os filtros devem ser implementados no backend e expostos via API para consumo do frontend.
- O formato de resposta paginada deve incluir: dados da página, total de registros, página atual, total de páginas, filtros aplicados.
- Frontend implementará: lista de dados + componentes de filtro + controles de paginação.
