	...
	plugins: [
		...
		Components({
			...
			dirs: [
				...
				'./resources/js/domain/Account/components',
				'./resources/js/domain/Auth/components',
				'./resources/js/domain/Category/components',
				'./resources/js/domain/CreditCard/components',
				'./resources/js/domain/CreditCardCharge/components',
				'./resources/js/domain/CreditCardInstallment/components',
				'./resources/js/domain/FixedExpense/components',
				'./resources/js/domain/Period/components',
				'./resources/js/domain/Settings/components',
				'./resources/js/domain/Transaction/components',
				'./resources/js/domain/Transfer/components',
				'./resources/js/domain/User/components',
			],
		}),
	],
});
