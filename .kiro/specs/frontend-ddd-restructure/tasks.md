...
- [x] 2. Separar types de `finance.ts` por domínio
  - [x] 2.1 Criar tipos compartilhados em `domain/Shared/types/`
  ...
  - [x] 2.2 Criar tipos por domínio financeiro
  ...
  - [x] 2.3 Atualizar imports de types nos arquivos consumidores
...
- [x] 3. Mover validations (schemas Zod) por domínio
  - [x] 3.1 Mover schemas para domínios correspondentes
...
- [x] 5. Mover stores por domínio
  ...
  - [x] 5.2 Atualizar imports de stores nos arquivos consumidores
    - Atualizar todos os imports de `@/modules/finance/stores/` para `@/domain/<Domínio>/stores/`
    - _Requisitos: 9.1, 9.2, 9.3_

- [x] 6. Criar services — Ports e Adapters
  - [x] 6.1 Criar Ports e Adapters para domínio Account
  ...
  - [x] 6.2 Criar Ports e Adapters para demais domínios financeiros
  ...
  - [x] 6.3 Criar Port e Adapter para Auth (Two Factor)
  ...
  - [x] 6.4 Criar Ports e Adapters compartilhados em Shared
...
- [x] 7. Checkpoint — Validar services
  - Executar `npm run types:check` para garantir que Ports e Adapters estão tipados corretamente
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Mover composables para domínios e Shared
  - [x] 8.1 Mover composables compartilhados para Shared
  ...
  - [x] 8.2 Mover composable de Auth
  ...
  - [x] 8.3 Atualizar imports de composables nos arquivos consumidores
...
- [x] 9. Mover components para domínios e Shared
  - [x] 9.1 Mover componentes de formulário para domínios
  ...
  - [x] 9.2 Mover componentes de Auth e Settings
  ...
  - [x] 9.3 Mover componentes compartilhados para Shared
    - Mover `DataTable.vue`, `DirectionBadge.vue`, `FilterBar.vue`, `StatusBadge.vue` para `domain/Shared/components/`
    - _Requisitos: 4.1_

  - [x] 9.4 Atualizar imports de components nos arquivos consumidores
...
- [x] 11. Atualizar configurações e documentação
  ...
  - [x] 11.2 Atualizar `conventions.md`
...
- [x] 12. Validação pós-migração e limpeza
  - [x] 12.1 Executar validação completa
  ...
  - [x] 12.2 Remover estrutura antiga `modules/`
